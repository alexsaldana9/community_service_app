...
u1 = User.create(name: 'David', email: 'david@gmail.com', password:'123456', password_confirmation:'123456', street_address: '1301 Sawgrass Corporate Pkwy', city: 'Sunrise', state: 'Fl', zipcode: '33323', age: '28', occupation: 'senior developer')
...
Event.create(name: 'Senior Pitch Day!', description: 'text1 - Senior Pitch Day', user_id: u1.id, date: '2017-05-20' , street_address: '1301 Sawgrass Corporate Pkwy', city: 'Sunrise', state: 'Fl', zipcode: '33323',category_id: c1.id)
Event.create(name: 'Tree Planting Day!', description: 'text2 - Tree Planting Day', user_id: u2.id, date: '2017-06-20', street_address: '6801 Main St', city: 'Miami Lakes', state: 'Fl', zipcode: '33014' ,category_id: c2.id)
Event.create(name: 'Animal Shelter Help Day!', description: 'text - Animal Shelter Help Day', user_id: u3.id , date:'2017-07-20', street_address: '11200 SW 8th St', city: 'Miami', state: 'Fl', zipcode: '33199' ,category_id: c3.id)
Event.create(name: 'Education Day!', description: 'text - Education Day', user_id: u4.id , date: '2017-08-20' , street_address: '11200 SW 8th St', city: 'Miami', state: 'Fl', zipcode: '33199' ,category_id: c4.id)
Event.create(name: 'Feed the Hungry!', description: 'text - Feed the Hungry', user_id: u5.id , date: '2017-09-20', street_address: '300 NE 2nd Ave', city: 'Miami', state: 'Fl', zipcode: '33132' ,category_id: c5.id)
